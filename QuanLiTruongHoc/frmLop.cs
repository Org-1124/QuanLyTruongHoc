...
namespace QuanLiTruongHoc
{
    public partial class frmLop : Form
    {
        ...
        public void SetHeaderColumn()
        {
            ...
            dgvLopHoc.Columns["TenChuNhiem"].HeaderText = "Chủ nhiệm";
            dgvLopHoc.Columns["TenLopTruong"].HeaderText = "Lớp trưởng";
            dgvLopHoc.Columns["TenLop"].HeaderText = "Tên Lớp";
            dgvLopHoc.Columns["SoLuong"].HeaderText = "Số lượng";
            dgvLopHoc.Columns["IDChuNhiem"].Visible=false;
            dgvLopHoc.Columns["IDLopTruong"].Visible = false;
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            l.IDChuNhiem = (int)cboTenGiaoVien.SelectedValue;
            l.IDLopTruong = (int)cboTenLopTruong.SelectedValue;
            // khi bấm phím sửa 
            if(ktluu==1)
            {
                try
